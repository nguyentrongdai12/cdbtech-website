...
<head>
    ...
    <title>CDB TECH Admin - Login</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <!-- <img class="bg-login-image" src="./img/CDB-LOGO.png" alt=""> -->
                                <div class="bg-login-image"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">CDB TECH Admin page!</h1>
                                    </div>
                                    <form class="user" action="login_controller.php" method ="post">
