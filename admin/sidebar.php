...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
    ...
    <div class="sidebar-brand-text mx-3">CDB Tech <sup>Admin</sup></div>
</a>
...
<li class="nav-item">
    ...
    <div id="collapsemenu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="index.php?pages=menu">Tất cả menu</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    ...
    <div id="collapseproject" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Dự án, công việc, giải pháp:</h6>
            <a class="collapse-item" href="index.php?pages=all_project">Tất cả dự án</a>
            <a class="collapse-item" href="index.php?pages=category_project">Phân loại dự án</a>
        </div>
    </div>
</li>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#accordioncustomers"
        aria-expanded="true" aria-controls="collapsePages">
        <i class="fas fa-user-alt"></i>
        <span>Đối tác - Khách hàng</span>
    </a>
    <div id="accordioncustomers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Đối tác - Khách hàng:</h6>
            <a class="collapse-item" href="index.php?pages=all_project">Tất cả đối tác - khách hàng</a>
        </div>
    </div>
</li>
